...
public class ChatGptChatFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        initMultiRoundChatAiApi("do what the user ask you to do");
        initComponent(root);
        return root;
    }


    private void initMultiRoundChatAiApi(String command) {
        multiRoundChatAiApi = new MultiRoundChatAiApi(command);
    }
