...
public class SentencePatternTrainingActivity extends AppCompatActivity {
    ...
    private void initComponent() {
        ...
        hintQuestionTextView.setText(R.string.sentence_pattern_hint_question);
    ...
    private void initSentencePatternChat(String topic) {
        ...
        trainingMaterial.prepareSentencePatternExamplesData(topic, new TrainingMaterial.ReceiveSentencePatternExamplesCallback() {
            @Override
