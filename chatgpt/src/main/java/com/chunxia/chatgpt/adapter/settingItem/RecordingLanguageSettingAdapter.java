...
public class RecordingLanguageSettingAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public RecordingLanguageSettingAdapter(ArrayList<SettingInfo> data) {
        items = data;
    }
