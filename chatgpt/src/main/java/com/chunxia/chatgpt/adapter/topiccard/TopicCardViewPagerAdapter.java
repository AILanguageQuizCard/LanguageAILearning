...
public class TopicCardViewPagerAdapter extends PagerAdapter {
    ...
    public TopicCardViewPagerAdapter(Application application, ArrayList<String> titleList, ArrayList<LearnCard> learnCards) {
    ...
    public Object instantiateItem(ViewGroup container, int position) {
        ...
        ((TextView) view.findViewById(R.id.topic_card_sentence)).setText(learnCards.get(position).getSentence());
        TextView translateView = view.findViewById(R.id.topic_card_translation);
        translateView.setText(learnCards.get(position).getTranslation());
        ...
        playButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                text2VoiceModel.onSpeak(learnCards.get(position).getSentence());
            }
        });
