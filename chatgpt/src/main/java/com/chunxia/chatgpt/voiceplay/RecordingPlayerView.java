package com.chunxia.chatgpt.voiceplay;

import static com.chunxia.chatgpt.voiceplay.Constant.BROADCAST_PLAY_RECORDING_EVENT;
import static com.chunxia.chatgpt.voiceplay.Constant.PLAYING_DATA;
import static com.chunxia.chatgpt.voiceplay.Constant.ZERO;
...
//            seekbarV.getThumb().setColorFilter(getResources().getColor(android.R.color.transparent), PorterDuff.Mode.SRC_IN);
    ...
    final OnClickListener imgPlayNoFileClickListener = new OnClickListener() {
        ...
        public void onClick(View v) {
            ...
            screens.showToast("File not found!");
        }
    };
