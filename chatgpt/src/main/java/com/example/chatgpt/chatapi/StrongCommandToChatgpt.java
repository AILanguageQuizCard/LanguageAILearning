...
public class StrongCommandToChatgpt {
    ...
    public static final String TRANSLATION_TO_ENGLISH_COMMAND="Translate anything user say to you into English, and explain the translation";

    public static final String TRANSLATION_TO_ENGLISH_COMMAND_ADD_TO_USER ="Translate anything I say to you into English, and explain the translation";
